        ...
        <div class="col-md-12">
            <div class="portlet light bordered">
                ...
                <div class="portlet-body">
                    ...
                    <p class="form_p">
                        <span class="userk">通知开始日期：</span><input type="date" name= 'kstime' id="kstime" @if($kid && $flag !=1) value="{{$lists->kstime}}"@else value= '' @endif>
                    </p>
                    <p class="form_p">
                        <span class="userk">通知结束日期：</span><input type="date" name= 'jstime' id="jstime" @if($kid && $flag !=1) value="{{$lists->jstime}}"@else value= '' @endif>
                    </p>
                    <p class="form_p">
