    ...
    <div class="col-md-12">
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    <span class="caption-subject font-dark sbold uppercase">批量添加二维码</span>
                </div>
            </div>
            <div class="portlet-body">

                <form action="{{route('manage_shake_shakeformsadd')}}" method="post" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group form-md-line-input">
                            <label class="col-md-2 control-label">品牌商数量</label>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="number" name="number" value="" class="form-control number">
