...
Route::any('fasongdx' , 'IndexController@fasongdx')->name('fasongdx');
//首页品牌商数据
...
Route::group(['prefix'=>'account' , 'as'=>'account_'] , function(){
    ...
    Route::any('kolcreatexecl', 'AccountController@kolcreatexecl')->name('kolcreatexecl');
});
...
Route::group(['prefix'=>'user' , 'as'=>'user_'] , function(){
    ...
    Route::post('xiugai' , 'UserController@xiugai')->name('xiugai');
    Route::post('editacc' , 'UserController@editacc')->name('editacc');
    Route::post('execuplodepass' , 'UserController@execuplodepass')->name('execuplodepass');
    Route::post('execuplodename' , 'UserController@execuplodename')->name('execuplodename');
});
