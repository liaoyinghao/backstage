...
Calendar.prototype.show = function(dateObj, popControl) {
	...
	//this.panel.style.left = xy.x - 564 + "px";
	//this.panel.style.top = (xy.y + dateObj.offsetHeight) -80+ "px";
	this.panel.style.left = (xy.x + dateObj.offsetWidth) -220 + "px";
	this.panel.style.top = (xy.y + dateObj.offsetHeight) -70 + "px";
...
document
		.write('background-color: #FFFFFF;border: 1px solid #CCCCCC;width:200px;font-size:12px;margin-left:25px;"></div>');
/**if (document.all) {
	document
